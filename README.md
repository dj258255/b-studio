...
작업은 이슈와 PR 단위로 남겼습니다. 커밋 기록(2026-09-10 ~ 09-17)을 영역별로 묶으면 다음 순서로 쌓였습니다.
...
이슈와 PR로 남긴 정도는 시기마다 달랐습니다. 09-10부터 09-12까지는 PR 38개가 병합돼 커밋과 PR이 거의 1대1로 붙었습니다. 09-13 이후 멀티 모델 라우터, Agent Fleet, 워크플로 강제, 작업 분해 같은 기능은 PR 없이 main에 바로 커밋했습니다. 화면 문법 정리 작업은 이슈 #39와 PR #40으로 남아 있고 아직 병합 전입니다.
